...
interactive follow-up use Claude-native configuration in the isolated home.
...
setting is not translated. Connect/continue remains unsupported and fails
clearly.
