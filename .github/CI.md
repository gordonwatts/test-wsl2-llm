...
distribution. The package job installs the wheel into a temporary environment
outside the checkout, runs the installed CLI's help and `template init`
commands, and checks that the packaged schema and pricing resources are
available.
